...
interface ProfileCardProps {
    ...
    onContactClick?: () => void;
    showIcon?: boolean; // Add missing prop types
    showBehindGlow?: boolean; // Add missing prop types
    customInnerGradient?: string; // Add missing prop types
}
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
    ...
    const getOffsets = (evt: MouseEvent | PointerEvent | Touch, el: HTMLElement) => {
    ...
    const handlePointerLeave = useCallback(() => {
        ...
        const checkSettle = () => {
            const { x, y, tx, ty } = tiltEngine.getCurrent() || { x: 0, y: 0, tx: 0, ty: 0 };
    ...
    useEffect(() => {
        ...
        // Cast handlers to any to bypass strict React TS event type mismatches if necessary,
        // or rely on correct type inference.
        // For native addEventListener, we need to match the correct event types.
        ...
        const handleClick = () => {
            ...
            if (anyMotion && typeof anyMotion.requestPermission === 'function') {
                anyMotion
                    ...
                    .then((state: string) => {
                        if (state === 'granted') {
                            // Fix: window.addEventListener expects EventListenerOrEventListenerObject
